  ...
  return (
    <>
      ...
      <div className="mx-auto flex w-full flex-col items-center justify-center text-center">
        ...
        <p className="text-2xl my-8">Break free from takedowns, embrace unlimited uploads!</p>
        <div className="mt-8 flex w-full">
          <div className="mr-4 flex w-1/3 flex-col rounded-xl bg-iexyellow p-8 bg-cover"
          ...
          <div className="mx-4 flex w-1/3 flex-col rounded-xl bg-iexyellow p-8 bg-cover"
                      style={{backgroundImage:`url("https://framerusercontent.com/modules/assets/2048/JTTdZra5wxa5h66fJ6xcdSrhck~JI7WW_eXGA4npCJf4aYpm6pYEAlXnzaosDvS7E8qydI.jpg")`}}>
                      
            <NavLink to="/guides/how-to-index" relative="path">
              <img src={require("../assets/indexing-logo-white.png")} alt="Index" className="mx-auto h-28" />
              <h2 className="text-iexblk text-lg">I want to index content</h2>
            </NavLink>
          </div>

          <div className="ml-4 flex w-1/3 flex-col rounded-xl bg-iexyellow p-8 bg-cover"
          style={{backgroundImage:`url("https://framerusercontent.com/modules/assets/2048/JTTdZra5wxa5h66fJ6xcdSrhck~JI7WW_eXGA4npCJf4aYpm6pYEAlXnzaosDvS7E8qydI.jpg")`}}>
            <NavLink to="/search" relative="path">
              <img src={require("../assets/download-logo-white.png")} alt="Upload" className="mx-auto h-28" />
